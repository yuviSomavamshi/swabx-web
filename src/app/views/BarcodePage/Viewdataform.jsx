        ...
        <ValidatorForm ref="form" onSubmit={this.handleSubmit} onError={(errors) => null}>
          {/* <div style={{textAlign:"center"}}>
              <SearchField
                   ...
                   classNames="test-class searchwidth"
                />
                </div>
     
       <div class="viewdatastyle" >
      {filteredData.map(item => (
           <div style={{margin:"5px",textDecoration:"underline",fontSize:"18px"}}>
             <a onClick={this.handleLocationModal}>
             { item.label }
             </a>
            </div>
          ))}
          ...
          <div>
            <div style={{ textAlign: "center" }}>
              ...
              />
              {/* <input className="searchwidth" placeholder="Search..." value={filter} onChange={this.handleChange} /> */}
            </div>
            <div class="viewdatastyle">
              {filteredData.map((item) => (
                <div
